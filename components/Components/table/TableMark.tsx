        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="my-6 container mx-auto flex flex-row lg:flex-row items-center lg:items-center justify-between ">
            ...
            <Link href="/admin/marks/new">
              <a  className="transition duration-150 ease-in-out hover:bg-orange-600 focus:outline-none border bg-orange-500 rounded text-white px-8 py-2 text-sm">Nueva Marca</a>
            </Link>
          </div>
